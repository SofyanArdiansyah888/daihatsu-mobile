...
export default function RiwayatCheckpointModal({isOpen, handleGroupModal, selectedData, setSelectedData}: IPropsModal) {
    ...
    function handleSubmit(value: any) {
        if (selectedData) {
            update({
                ...value,
                dari: value.dari.format('HH:mm:ss'),
                sampai: value.sampai.format('HH:mm:ss'),
            })
            return
        }
        create({
    ...
    useEffect(() => {
        if (selectedData) {
            ...
            form.setFieldsValue({
                ...selectedData,
                dari: moment(selectedData?.dari, 'HH:mm'),
                sampai: moment(selectedData?.sampai, 'HH:mm')
            })
        }
        if (!isOpen) {
            setImagePreview("")
    ...
    return <FormModal<ShiftEntity>
        ...
        loading={selectedData ? updateLoading : createLoading}
    >
